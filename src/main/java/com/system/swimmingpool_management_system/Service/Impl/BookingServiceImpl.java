...
import com.system.swimmingpool_management_system.Repo.BookingRepo;
import com.system.swimmingpool_management_system.Repo.SwimmingpoolRepo;
import com.system.swimmingpool_management_system.Repo.UserRepo;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingPojo saveOrder(BookingPojo bookingPojo) {
        ...
        booking.setSwimmingpool(swimmingpoolRepo.findById(bookingPojo.getFid()).orElseThrow());
    ...
    public Booking fetchById(Integer id) {
        ...
        application =Booking.builder()
                ...
                .swimmingpool(application.getSwimmingpool())
...
//        return time;
    ...
    private void sendPassword(String email, String name, String swimmingpool, String date, String time){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Booking Verification");
        message.setText("Hi"+ name+ "You have booked"+swimmingpool+"swimmingpool"+"on"+ date+"from"+time+"please be on time");
    ...
    public void processPasswordResetRequest(String email){
        ...
        if(bookingOptional.isPresent()){
            ...
            String swimmingpool = booking.getSwimmingpool().getSwimmingpoolname();
            String time = booking.getStarting();
            String date = String.valueOf(booking.getDate());
            sendPassword(email, name, swimmingpool, time, date);
