...
import com.system.swimmingpool_management_system.Pojo.UserPojo;
...
import com.system.swimmingpool_management_system.entity.User;
...
//    }
    ...
    public String getSwimmingpoolProfiile(@PathVariable("id") Integer id, Model model, Principal principal ){
        ...
        model.addAttribute("userdata",userService.findByEmail(principal.getName()));
        model.addAttribute("bookedswimmingpool", booking);
        return "editbooking";
    }
...
//        Booking booking =bookingService.fetchById(id);
//        model.addAttribute("bookedswimmingpool", new BookingPojo(booking));
//        return "redirect:/home/homepage";
//    }
